...
int run_soak_command(int duration_seconds, const std::string& profile_name) {
...
int run_concurrency_stress_command(int duration_seconds, const std::string& profile_name) {
...
int run_concurrency_stress_json_command(int duration_seconds, const std::string& profile_name) {
    const auto profile = parse_concurrency_stress_profile_name(profile_name);
    if (!profile.has_value()) {
        std::cerr << "Unknown concurrency stress profile: " << profile_name << std::endl;
        return 1;
...
int run_soak_command_entrypoint(int duration_seconds, const std::string& profile_name) {
    return run_soak_command(duration_seconds, profile_name);
}

int run_concurrency_stress_command_entrypoint(int duration_seconds, const std::string& profile_name) {
    return run_concurrency_stress_command(duration_seconds, profile_name);
}

int run_concurrency_stress_json_entrypoint(int duration_seconds, const std::string& profile_name) {
    return run_concurrency_stress_json_command(duration_seconds, profile_name);
}
